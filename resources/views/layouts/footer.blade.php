<div class="footer">
    <img src="/assets/icons/oldcomputerplant6.png" id="bot-green" width="280px" height="292px">
    <div class="last-bar">
        <div class="brick1">
            <a href="" id="ab">
                <p id="ab">[About]</p>
        ...
        <div class="brick3">
            <a href="/rules" id="rules">
                <p id="rules">[Rules]</p>
            </a>
            <a href="/guideline" id="fogu">
    ...
    <div class="badgerow1">
        ...
        <a target="_blank" href="https://melonland.net"><img alt="Visit the MelonLand!" src="https://melonland.net/images/melonland-badge-2.gif"></a>
