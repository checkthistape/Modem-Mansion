...
<body>
    <div class="wrapper">
        ...
        <div class="tabs">
            <div class="tab"><a href="audio.php" style="text-decoration: underline;"><img class="icon" id="audio" src="../icons/audio.png" width="32"
        ...
        <div class="content">
            ...
            <div class="right-part">
                ...
                <div class="row">
                    <div class="def-button">
                        <div class="abutton">
                            <button class="windows98button" id="soundbutton" style="width: max-content; height: 58px;">Play</button>
                        </div>
                        <div class="metadata">
                            <table class="metadata">
                                <tr>
                                    <td id="sup">uploaded by:</td>
                                    <td>jankinsasdasdasd</td>
                                </tr>
                                <tr>
                                    <td id="sup">date:</td>
                                    <td>2</td>
                    ...
                    <div class="add">
                        ...
                        <button class="windows98button" style="width: 120px; height: 40px;">Add</button>
                    </div>
